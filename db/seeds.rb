...
db0 = Database.create(name: "No database required.", description: "")
db1 = Database.create(name: "You haven't selected a database yet!", description: "")
db2 = Database.create(name: "PostgreSQL", description: "Useful database")
db3 = Database.create(name: "SQLite", description: "Useful database")
db4 = Database.create(name: "MySQL", description: "Useful database")
db5 = Database.create(name: "MariaDB", description: "Useful database")
...
use1 = User.create(name: "Admin", password_digest: BCrypt::Password.create("1234"))
